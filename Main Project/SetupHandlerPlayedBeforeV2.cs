...
public class SetupHandler : MonoBehaviour
{
    ...
    void Start()
    {
        AcceptedResponses = new string[14]{"Yes", "yes", "Yeah", "yeah", "Yup", "yup", "Yep", "yep", "No", "no", "Nope", "nope", "Nah", "nah"}; 
    }
    ...
    public void CheckInput(){
        ...
        if(IsAccepted == true)
        {
            if(YesNo == AcceptedResponses[0] || YesNo == AcceptedResponses[1]  || YesNo == AcceptedResponses[2]  || YesNo == AcceptedResponses[3] || YesNo == AcceptedResponses[4] || YesNo == AcceptedResponses[5] || YesNo == AcceptedResponses[6] || YesNo == AcceptedResponses[7])
            {
