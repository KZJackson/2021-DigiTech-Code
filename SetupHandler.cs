...
public class SetupHandler : MonoBehaviour
{
    ...
    //Gets the text input from the input field, and assigns it to the PlayerName variable
    ...
    //Gets the text input from the input field, and assigns it to the YesNo variable
    //Function is called from the 'On Edit End' component in the input field
    ...
    public void CheckInput(){
        ...
        if(IsAccepted == true)
        {
            if(YesNo == AcceptedResponses[1] || YesNo == AcceptedResponses[2])
            {
                ...
                Debug.Log("Response was " + YesNo + ". Response met expected values. Game Screen loaded");
            }
